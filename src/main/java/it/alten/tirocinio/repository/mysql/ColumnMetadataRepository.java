 ...
 */
public interface ColumnMetadataRepository extends CrudRepository<ColumnMetadataMySql, String> {
	/*
	...
	Set<ColumnMetadataMySql> getAllDBColumns();
	...
	Set<ColumnMetadataMySql> getAllDBColumnsByTableAndSchema(@Param("table_schema") String tableSchema, @Param("table_name") String tableName);
	...
	ColumnMetadataMySql getDBColumnByNameAndTableAndSchema(@Param("table_schema") String tableSchema, @Param("table_name") String tableName, @Param("column_name") String columnName);
	...
	Set<ColumnMetadataMySql> getAllDBNotNullColumnsByTableAndSchema(@Param("table_schema") String tableSchema, @Param("table_name") String tableName);
	...
	Set<ColumnMetadataMySql> getAllDBNullableColumnsByTableAndSchema(@Param("table_schema") String tableSchema, @Param("table_name") String tableName);
	...
	Set<ColumnMetadataMySql> getAllDBIntegerColumnsByTableAndSchema(@Param("table_schema") String tableSchema, @Param("table_name") String tableName);
	...
	Set<ColumnMetadataMySql> getAllDBColumnsWithDefaultValueByTableAndSchema(@Param("table_schema") String tableSchema, @Param("table_name") String tableName);
	...
	Set<ColumnMetadataMySql> getAllDBColumnsByDataTypeAndTable(@Param("column_type") String columnType, @Param("table_schema") String tableSchema, @Param("table_name") String tableName);
