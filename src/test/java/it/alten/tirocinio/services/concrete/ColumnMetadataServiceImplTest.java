...
public class ColumnMetadataServiceImplTest {
	@Mock
	private ColumnMetadataRepository repository;
	
	@InjectMocks
	private ColumnMetadataServiceImpl service;
	...
	public void getAllColumnsByTableTest_schemaNameNotEmpty_tableNameNotEmpty() {
		...
		when(repository.getAllDBColumnsByTableAndSchema(schemaName.toUpperCase(), tableName.toUpperCase())).thenReturn(testSet);
	...
	public void getColumnByNameAndTableTest_schemaNameNotEmpty_tableNameNotEmpty_columnNameNotEmpty() {
		...
		when(repository.getDBColumnByNameAndTableAndSchema(schemaName.toUpperCase(), tableName.toUpperCase(), columnName.toUpperCase())).thenReturn(c);
	...
	public void getColumnNotNullByTableTest_schemaNameNotEmpty_tableNameNotEmpty() {
		...
		when(repository.getAllDBNotNullColumnsByTableAndSchema(schemaName.toUpperCase(), tableName.toUpperCase())).thenReturn(testSet);
	...
	public void getColumnNullableByTableTest_schemaNameNotEmpty_tableNameNotEmpty() {
		...
		when(repository.getAllDBNullableColumnsByTableAndSchema(schemaName.toUpperCase(), tableName.toUpperCase())).thenReturn(testSet);
	...
	public void getIntegerColumnByTableTest_schemaNameNotEmpty_tableNameNotEmpty() {
		...
		when(repository.getAllDBIntegerColumnsByTableAndSchema(schemaName.toUpperCase(), tableName.toUpperCase())).thenReturn(testSet);
	...
	public void getColumnWithDefaultValueByTableTest_schemaNameNotEmpty_tableNameNotEmpty() {
		...
		when(repository.getAllDBColumnsWithDefaultValueByTableAndSchema(schemaName.toUpperCase(), tableName.toUpperCase())).thenReturn(testSet);
	...
	public void getColumnByTypeAndTableTest_schemaNameNotEmpty_tableNameNotEmpty_dataTypeNotEmpty() {
		...
		when(repository.getAllDBColumnsByDataTypeAndTable(dataType.toUpperCase(), schemaName.toUpperCase(), tableName.toUpperCase())).thenReturn(testSet);
