...
public class TableConstraintMetadataServiceImplTest {
	@Mock
	private TableConstraintMetadataRepository repository;
	
	@InjectMocks
	public TableConstraintMetadataServiceImpl service;
	...
	public void getAllConstraintsTest_tableNameNotEmpty_schemaNameNotEmpty() {
		...
		when(repository.getAllConstraintsByTable(tableName.toUpperCase(), schemaName.toUpperCase())).thenReturn(testSet);
	...
	public void getAllUniqueConstraintsTest_tableNameNotEmpty_schemaNameNotEmpty() {
		...
		when(repository.getUniqueConstraintsByTable(tableName.toUpperCase(), schemaName.toUpperCase())).thenReturn(testSet);
	...
	public void getAllForeignKeyConstraintsTest_tableNameNotEmpty_schemaNameNotEmpty() {
		...
		when(repository.getForeignKeyConstraintsByTable(tableName.toUpperCase(), schemaName.toUpperCase())).thenReturn(testSet);
