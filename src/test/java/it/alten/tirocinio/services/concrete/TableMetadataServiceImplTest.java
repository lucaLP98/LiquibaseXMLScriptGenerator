...
public class TableMetadataServiceImplTest {
	...
	@InjectMocks
	private TableMetadataServiceImpl service;
	...
	public void getAllTablesBySchemaTest() {
		...
		when(tableMetadataRepository.getAllDBTablesBySchema(schemaName.toUpperCase())).thenReturn(testSet);
	...
	public void getTableByNameAndSchema() {
		...
		when(tableMetadataRepository.getDBTablesByNameAndSchema(schemaName.toUpperCase(), tableName.toUpperCase())).thenReturn(t1);
